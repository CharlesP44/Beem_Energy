...
SENSOR_DEFINITIONS = {
    ...
    "totalEnergyExported": ("kWh", "mdi:home-export-outline),
    "totalEnergyImported": ("kWh", "mdi:home-import-outline"),
    "totalChargedEnergy": ("kWh", "mdi:battery-charging-100),
    "totalDischargedEnergy": ("kWh", "mdi:battery-charging-20"),
